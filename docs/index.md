...
| **IAA Analysis** | Pairwise inter-annotator agreement (o2o per-message accuracy via Hungarian alignment for disentanglement; α × LinkF1 + (1−α) × TypeAcc for adjacency pairs) |
